...
- For crisis or suicidal thoughts, always share helplines immediately and urge them to call
...
- Always end with an offer to help further or suggest booking an appointment`;
...
export default function DRBPlusChatbot() {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      setIsTyping(false);
      addBotMessage("Sorry, I am having trouble connecting. Please call us directly at +91 94351 66121 or WhatsApp us.");
      setShowOptions(true);
    }
  };
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 20, color: "#fff", boxShadow: "0 2px 8px rgba(0,0,0,0.3)", flexShrink: 0,
          }}>🧠</div>
          <div>
        ...
        <div style={{
          ...
          {!started && (
            <div style={{
              ...
              justifyContent: "center", flex: 1, gap: 16, padding: "40px 20px",
            }}>
              <div style={{
                width: 80, height: 80, borderRadius: "50%",
                background: "linear-gradient(135deg, #075E54, #25D366)",
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: 36, boxShadow: "0 8px 24px rgba(7,94,84,0.35)",
              }}>🧠</div>
              ...
              <button onClick={handleStart} style={{
                ...
                cursor: "pointer", boxShadow: "0 4px 16px rgba(7,94,84,0.4)",
              }}>Start Chat</button>
            </div>
          )}
          ...
          {messages.map((msg) => (
            <div key={msg.id} style={{ display: "flex", justifyContent: msg.from === "user" ? "flex-end" : "flex-start" }}>
              <div style={{
                ...
                padding: "10px 14px", fontSize: 13, fontFamily: "Arial, sans-serif",
                lineHeight: 1.55, color: "#1a1a1a", boxShadow: "0 1px 3px rgba(0,0,0,0.12)",
              }}>
          ...
          {isTyping && (
            <div style={{ display: "flex", justifyContent: "flex-start" }}>
              <div style={{
                ...
                {[0,1,2].map(i => (
                  <div key={i} style={{
                    width: 7, height: 7, borderRadius: "50%", background: "#128C7E",
          ...
          {started && showOptions && !isTyping && messages.length > 0 && (
            <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: 4 }}>
              {QUICK_OPTIONS.map((opt, i) => (
                <button key={i} onClick={() => handleQuickOption(opt)} style={{
                  background: "#fff", border: "1.5px solid #128C7E", borderRadius: 16,
                  padding: "6px 12px", fontSize: 11, color: "#075E54", fontWeight: "600",
        ...
        {started && (
          <div style={{
            ...
            borderTop: "1px solid #ddd", display: "flex", gap: 8, flexShrink: 0,
          }}>
            <input
              value={input}
              ...
              style={{
                flex: 1, border: "none", borderRadius: 20, padding: "10px 16px",
            ...
            <button onClick={handleSubmit} style={{
              ...
              background: input.trim() ? "linear-gradient(135deg, #075E54, #128C7E)" : "#ccc",
        ...
        <div style={{
          background: "#f0f0f0", padding: "6px", textAlign: "center",
          fontSize: 10, color: "#999", fontFamily: "Arial, sans-serif",
        }}>
